...
export function MenuSection() {
  ...
  return (
    <section
      id="menu"
      className="texture-grain relative overflow-hidden bg-background py-14 sm:pt-20 sm:pb-[120px]"
    >
          ...
          <div className="relative flex w-full max-w-none flex-col items-center sm:max-w-3xl">
            <div className="relative w-full max-w-none [perspective:1100px] sm:max-w-2xl">
              <div
                ...
                style={{
                  transform: entered ? "rotateY(0deg) scale(1)" : "rotateY(-85deg) scale(0.92)",
                  opacity: entered ? 1 : 0,
                }}
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    transition: dur
                      ? `transform ${dur}ms cubic-bezier(0.33,0,0.3,1), filter ${dur}ms linear`
                      : "none",
                                ...
                                <div className="relative mb-2">
                                  <div className="flex items-center gap-4">
                                    ...
                                    category.extras.inlineGroup === item.group ? (
                                      <span className="inline-block -rotate-[6deg] origin-center whitespace-pre-line font-marker text-[14px] leading-tight text-charcoal/80 sm:ml-10">
                                    ...
                                    return (
                                      ...
                                      >
                                        <span className="flex items-center gap-2">
                                          {ExtraIcon ? (
                                            <ExtraIcon
                                              className="h-6 w-6 shrink-0 -translate-y-0.5"
                                              strokeWidth={1.5}
                                            />
                                          ) : null}
                                          {extra.name ? (
                                        ...
                                        {extra.price ? (
                                          <span className="font-subhead font-bold">
                                            {extra.price}
                                          </span>
                                        ) : null}
                                      </li>
