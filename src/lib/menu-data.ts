...
export const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Chicken Tenders", note: "4 pcs / 8 pcs", prices: ["-", "-"] },
      { name: "Chili Cheese", note: "4 pcs / 8 pcs", prices: ["-", "-"] },
      { name: "Onion Rings", note: "M / L", prices: ["-", "-"] },
    ],
    extras: {
      title: "Sauce",
      items: [
  ...
  },
  {
    ...
    items: [
      ...
      { group: "Beer", name: "Singaraja", note: "small bottle", price: "-" },
      {
        group: "Santai",
        name: "Lemon & Lime",
      ...
      { group: "Soft Drinks", name: "Still Water", price: "-" },
    ],
    footnote: "Prices include tax and service",
  },

  {
    ...
    items: [
      ...
      { group: "Milkshakes", name: "Strawberry", price: "-" },
      { group: "Desserts", name: "Cookies", price: "-" },
      { group: "Desserts", name: "Chocolate Brownie", price: "-" },
      {
        group: "Sundae*",
        name: "Salted Caramel",
      ...
      { group: "Sundae", name: "Chocolate", description: "With peanuts on top", price: "-" },
    ],
    extras: {
